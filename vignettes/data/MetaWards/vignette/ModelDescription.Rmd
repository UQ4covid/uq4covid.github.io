...
user <- "# Normal status" %>%
  ...
  c("") %>%
  c("# contact matrix") %>%
  c(".contact_matrix_filename = \"inputs/coMix_matrix.csv\"") %>%
  c("") %>%
...
```{r, fig.width = 5, fig.height = 10, echo = FALSE, message = FALSE, warning = FALSE}
p1 <- data.frame(
...
![](../data/hospitalStays/expFits.svg)
...
![](../data/hospitalStays/fittedLnBayes.svg)
...
![](../data/hospitalisation/mixturePosterior.png)
