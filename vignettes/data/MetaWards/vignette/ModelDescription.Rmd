...
system("zip metawards.zip model_code/* R_tools/* vignette/ModelDescription.html inputs/*.csv inputs/hospStays.rds inputs/pathways.rds *.R README.md")
setwd(tempdir)
```
