...
\begin{align}
    \mbox{$R_0$}&: (2, 4.5) \qquad \mathrm{from Leon and Rob}\\
    \mbox{mean incubation period ($T_E + T_P$)}&: (?, ?)---Challen et al. (2020)\\
    \mbox{mean infection to admission period ($T_E + T_P + T_{I_1}$)}&: (?, ?)---Challen et al. (2020)\\
    \mbox{mean onset to admission period ($T_{I_1}$)}&: (?, ?)---Challen et al. (2020)\\
    \mbox{mean onset to end-of-infectiousness ($T_{I_1} + T_{I_2}$)}&: (?, ?)---Cevik / NEJM\\
    \mbox{mean hospital stay ($T_H$)}&: (?, ?)---Rob data\\
