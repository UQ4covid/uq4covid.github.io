...
You can alter `lower` and `upper` for any of the parameters (or even fix some if you like) here. See the [model description](./ModelDescription.html) to see what they all do.
...
If you have all the required libraries, you can just run the whole thing and, by default, you will get the total number of infections in hospitals per ward. There is a lot you can do to customise, and details can be found in the [Model Description](./ModelDescription.html). To get you started, here are some things you can change. 
